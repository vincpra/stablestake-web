...
export interface NODERewards extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
  ...
  methods: {
    ...
    oneNode(): NonPayableTransactionObject<string>;
    ...
    setOneNode(_oneNode: string): NonPayableTransactionObject<void>;

    setSushiOneNodeOnePair(
      _sushiOneNodeOnePair: string
    ): NonPayableTransactionObject<void>;
    ...
    sushiOneNodeOnePair(): NonPayableTransactionObject<string>;
